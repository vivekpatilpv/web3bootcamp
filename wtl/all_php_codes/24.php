...
mysqli_query($con, "CREATE TABLE if not exists `$table_name`(roll INT(5), name VARCHAR(100), year varchar(100), department VARCHAR(100), grades VARCHAR(100))");
...
<body>
    ...
    <div class="container" style="color: black !important;">
        <form id="contact" roll="contact" action="24.php" method="post">
...
<label for="radio3">Pass</label>
    ...
    $sql_search="SELECT * FROM `$table_name` WHERE  `grades`='first' and `department` = 'cse'";
